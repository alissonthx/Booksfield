        ...
        <div class="main-book">
            ...
            <div class="flex-row">
                <div class="card text-center card-book mt-1" style="width: 18rem;" height="40rem;">
                    <img src="../img/livro1.png" class="card-img-top img-book" alt="Livro 1">
                    <div class="card-body">
                ...
                <div class="card text-center card-book mt-1" style="width: 18rem;">
                    <img src="../img/livro2.png" class="card-img-top img-book" alt=" livro 2">
                    <div class="card-body">
                ...
                <div class="card text-center card-book mt-1" style="width: 18rem;">
                    <img src="../img/livro3.png" class="card-img-top img-book" alt="livro 3">
                    <div class="card-body">
